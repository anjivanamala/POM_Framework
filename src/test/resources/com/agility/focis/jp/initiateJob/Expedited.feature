...
Feature: Initiate Job - Air Freight - Expedited
  ...
  Scenario Outline: Create an  Air Freight - Expedited - E2E - BackToBack Job without Template
    ...
    Examples:
      ...
      | DR1     | Job        | Job Booking     | Air Freight | Expedited   | E2E      | STK20016776       | STK20016775            | DAT      | US             | Chicago                 | Air Export        | Branch      | Yes           | IN                  | Mumbai                       | Air Import             | Branch           | Yes                | EK      | EK123        | ORD | BOM | 7   | 12      | 14  | 12      | BESTWAY TRANSPORT | 1    | 2       |
