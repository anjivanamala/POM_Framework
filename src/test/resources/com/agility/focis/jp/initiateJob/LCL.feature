...
#      | DR1     | Job        | Job Booking     | Ocean Freight | FCL         | E2E      | STK20016775       | STK20016776            | DAF      | Express | Prepaid  | Original    | IN             | Mumbai                  | Ocean Export      | Branch      | Yes           | US                  | Chicago                      | Ocean Import           | Branch           | Yes                |
      | DR2     | Job        | Job Booking     | Ocean Freight | LCL         | E2E      | STK20016776       | STK20016775            | DAT      | Express | Prepaid  | Original    | US             | Chicago                 | Ocean Export      | Branch      | Yes           | IN                  | Mumbai                       | Ocean Import           | Branch           | Yes                |
