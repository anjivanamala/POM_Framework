...
#      | <D_Haulier>  | <D_Coll_Date>         | <D_Del_Date>        |
    ...
    Examples:
      ...
      | DR2     | Job        | Job Booking     | Ocean Freight | FCL         | E2E      | Back To Back | STK20016775       | STK20016776            | DAT      | Express | Prepaid  | Original    | IN             | Mumbai                  | Ocean Export      | Branch      | Yes           | US                  | Chicago                      | Ocean Import           | Branch           | Yes                | MAEU    | INNSA            | 7      | INMAA              | 8      | INMAA            | 9      | AEDXB              | 10     | AEDXB            | 11     | USCHI              | 14     | Garrisons Logistics Pvt Ltd | 1           | 5          | BESTWAY TRANSPORT | 15          | 16         | Yes | No  | No   | No  |
